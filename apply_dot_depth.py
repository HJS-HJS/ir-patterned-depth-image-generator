...
gray0  = cv2.imread("gray_image_0.png", cv2.IMREAD_GRAYSCALE)
gray1  = cv2.imread("gray_image_1.png", cv2.IMREAD_GRAYSCALE)
depth0 = np.load('depth_image_0.npy')
depth1 = np.load('depth_image_1.npy')
